...
class CatPage extends React.Component {
    ...
    render() {
        ...
        const newCat = catList.filter((item, index) => index < 20).map(cat => (
        ...
        return (
            <div>
                ...
                <ul className="pagination">
                    ...
                    <li className="page-item"><Link className="page-link" to="/cat:page1"  onClick={this.nextPae}>1</Link></li>
                    <li className="page-item"><Link className="page-link" to="/cat:page1" href="">Next</Link></li>
                </ul>
            </div>
...
export default connect(mapStateToProps, action)(CatPage)